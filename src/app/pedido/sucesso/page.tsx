...
const contentMap = {
  ...
  pending: {
    ...
    desc: 'Seu pedido foi recebido e está aguardando confirmação. Para PIX, aguarde alguns minutos.',
  ...
  failed: {
    ...
    desc: 'Seu pagamento foi recusado. Tente novamente com outro cartão ou use o PIX.',
  ...
  unknown: {
    ...
    desc: 'Não conseguimos confirmar o status agora. Se o pagamento foi realizado, entraremos em contato.',
    cta: { label: 'Voltar ao Catálogo', href: '/produtos' },
  },
};
...
// Componente raiz com Suspense — obrigatório no Next.js 14+
